...
public class Ticket implements Estadisticas{
    ...
    public String toString(){
        return"Ticket{"+
                "numero_ticket="+numero_ticket_actual+
                ", fecha_ticket="+fecha_ticket+
                ", cliente_ticket="+cliente_ticket+
                ", paquete_turistico="+Arrays.toString(paquete_turistico)+
                '}';
    }
}
