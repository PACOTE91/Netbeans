...
public class Main implements Serializable {
    public static void menu(Ticket[] v) {
        ...
        do {
            ...
            System.out.println("5.-Ver todos tickets del vector");
            System.out.println("6.-Guardar todos los tickets en fichero texto");
            System.out.println("7.-Leer fichero texto");
            System.out.println("8.-Guardar en un fichero de objetos");
            System.out.println("9.-Leer tickets del fichero de objetos");
            System.out.println("0.-Salir.");
            num = teclado.leer_entero("Elije una opcion (0 para salir): \n");
            ...
            switch (num) {
                ...
                case 4:
                    ...
                    if (totaltickets > 0) {
                        ...
                        System.out.println(v[numero - 1]);
                        System.out.println("Precio del ticket = " + v[numero - 1].precio());
                ...
                case 5:
                    int cont = 0;
                    if (Ticket.getTotal_tickets() == 0) {
                        System.out.println("No hay tickets creados");
                    } else {
                        for (int i = 0; i < Ticket.getTotal_tickets(); i++) {
                            cont++;
                            if (cont == 6) {
                                String seguir = teclado.leer_cadena2("Presiona enter para ver 5 siguientes registros");
                ...
                case 6:
                    if (v[0] != null) {
                        nom_archivo = teclado.leer_cadena2("Introduce nombre para archivo");
                        File fich = new File(nom_archivo);
                ...
                case 8:
                    ...
                    try {
                        fs = new FileOutputStream("objetos.dat");
                        ...
                        System.out.println("\n Error, el fichero no se ha podido encontrar" + ex);
                    } catch (IOException ex) {
                        System.out.println("\n Error de E/S");
                        ex.printStackTrace();
                    } finally {
                ...
                case 9:
                    try {
                        ...
                        try {
                            f = new File("objetos.dat");
                            if (f.exists()) {
                                fe = new FileInputStream ("objetos.dat");
